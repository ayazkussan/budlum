...
- Part A — System: budget, behavior, memory, computer use, routing, tools, runtime context
- Part A ends with the Human: placeholder block
- Appendix B — Lubot Code agent surface: identity, capabilities, catalog, writing, work, activation
